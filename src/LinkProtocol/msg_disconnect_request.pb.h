...
#ifndef GOOGLE_PROTOBUF_INCLUDED_msg_5fdisconnect_5frequest_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_msg_5fdisconnect_5frequest_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_msg_5fdisconnect_5frequest_2eproto
...
struct TableStruct_msg_5fdisconnect_5frequest_2eproto {
...
class DisconnectRequest final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:UsvLink.DisconnectRequest) */ {
 public:
  ...
  inline void CopyFrom(const DisconnectRequest& from) {
  ...
  static ::absl::string_view FullMessageName() {
    return "UsvLink.DisconnectRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:UsvLink.DisconnectRequest)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_msg_5fdisconnect_5frequest_2eproto;
};
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_msg_5fdisconnect_5frequest_2eproto_2epb_2eh
