...
#ifndef GOOGLE_PROTOBUF_INCLUDED_msg_5fdisconnect_5fresponse_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_msg_5fdisconnect_5fresponse_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_msg_5fdisconnect_5fresponse_2eproto
...
struct TableStruct_msg_5fdisconnect_5fresponse_2eproto {
...
class DisconnectResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:UsvLink.DisconnectResponse) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "UsvLink.DisconnectResponse";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:UsvLink.DisconnectResponse)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_msg_5fdisconnect_5fresponse_2eproto;
};
...
// int32 ack = 1;
inline void DisconnectResponse::clear_ack() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.ack_ = 0;
}
inline ::int32_t DisconnectResponse::ack() const {
  // @@protoc_insertion_point(field_get:UsvLink.DisconnectResponse.ack)
  return _internal_ack();
}
inline void DisconnectResponse::set_ack(::int32_t value) {
  _internal_set_ack(value);
  // @@protoc_insertion_point(field_set:UsvLink.DisconnectResponse.ack)
}
inline ::int32_t DisconnectResponse::_internal_ack() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.ack_;
}
inline void DisconnectResponse::_internal_set_ack(::int32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.ack_ = value;
}
...
// optional string err_msg = 2;
inline bool DisconnectResponse::has_err_msg() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline void DisconnectResponse::clear_err_msg() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.err_msg_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& DisconnectResponse::err_msg() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:UsvLink.DisconnectResponse.err_msg)
  return _internal_err_msg();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void DisconnectResponse::set_err_msg(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.err_msg_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:UsvLink.DisconnectResponse.err_msg)
}
inline std::string* DisconnectResponse::mutable_err_msg() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_err_msg();
  // @@protoc_insertion_point(field_mutable:UsvLink.DisconnectResponse.err_msg)
  return _s;
}
inline const std::string& DisconnectResponse::_internal_err_msg() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.err_msg_.Get();
}
inline void DisconnectResponse::_internal_set_err_msg(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.err_msg_.Set(value, GetArena());
}
inline std::string* DisconnectResponse::_internal_mutable_err_msg() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.err_msg_.Mutable( GetArena());
}
inline std::string* DisconnectResponse::release_err_msg() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:UsvLink.DisconnectResponse.err_msg)
...
inline void DisconnectResponse::set_allocated_err_msg(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:UsvLink.DisconnectResponse.err_msg)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_msg_5fdisconnect_5fresponse_2eproto_2epb_2eh
