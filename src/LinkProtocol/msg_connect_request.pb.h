...
#ifndef GOOGLE_PROTOBUF_INCLUDED_msg_5fconnect_5frequest_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_msg_5fconnect_5frequest_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_msg_5fconnect_5frequest_2eproto
...
struct TableStruct_msg_5fconnect_5frequest_2eproto {
...
class ConnectRequest final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:UsvLink.ConnectRequest) */ {
 public:
  ...
  inline void CopyFrom(const ConnectRequest& from) {
  ...
  // @@protoc_insertion_point(class_scope:UsvLink.ConnectRequest)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_msg_5fconnect_5frequest_2eproto;
};
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_msg_5fconnect_5frequest_2eproto_2epb_2eh
